...
/**
 * 文件定向国际检测rediskey 常量类
 * @author liuh
 * @date 2022年10月18日
 */
public class IntDirectRedisKeyConstant {

	/**
	 * key项目前缀
	 */
	public final static String CACHE_PREFIX = "idt:";
