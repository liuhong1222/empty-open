...
public final class UploadUtil {
     ...
     * @throws Exception
     */
    public static synchronized String upload(String uploadPath, MultipartFile multipartFile, UploadFileNameHandle uploadFileNameHandle) throws Exception {
        // 文件保存目录
